...
func getTestAnsibleGalaxyProxyRepository(name string) repository.AnsibleGalaxyProxyRepository {
	return repository.AnsibleGalaxyProxyRepository{
		Name:   name,
		Online: true,
...
func TestAnsibleGalaxyProxyRepository(t *testing.T) {
	service := getTestService()
	repo := getTestAnsibleGalaxyProxyRepository("test-ansiblegalaxy-repo-proxy-" + strconv.Itoa(rand.Intn(1024)))
