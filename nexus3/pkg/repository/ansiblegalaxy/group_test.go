...
func getTestAnsibleGalaxyGroupRepository(name string) repository.AnsibleGalaxyGroupRepository {
	return repository.AnsibleGalaxyGroupRepository{
		Name:   name,
		Online: true,
...
func TestAnsibleGalaxyGroupRepository(t *testing.T) {
	service := getTestService()
	repo := getTestAnsibleGalaxyGroupRepository("test-ansiblegalaxy-repo-group-" + strconv.Itoa(rand.Intn(1024)))

	testProxyRepo := getTestAnsibleGalaxyProxyRepository("test-ansiblegalaxy-group-proxy-" + strconv.Itoa(rand.Intn(1024)))
