...
func getTestAlpineProxyRepository(name string) repository.AlpineProxyRepository {
	return repository.AlpineProxyRepository{
		Name:   name,
		Online: true,
...
func TestAlpineProxyRepository(t *testing.T) {
	service := getTestService()
	repo := getTestAlpineProxyRepository("test-alpine-repo-proxy-" + strconv.Itoa(rand.Intn(1024)))
