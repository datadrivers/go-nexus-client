...
import (
	...
	"github.com/datadrivers/go-nexus-client/nexus3/pkg/repository/ansiblegalaxy"
...
type RepositoryService struct {
	...
	// API Services
	AnsibleGalaxy *ansiblegalaxy.RepositoryAnsibleGalaxyService
...
func NewRepositoryService(c *client.Client) *RepositoryService {
	return &RepositoryService{
		...
		AnsibleGalaxy: ansiblegalaxy.NewRepositoryAnsibleGalaxyService(c),
